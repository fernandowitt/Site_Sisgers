...
#     first_name = models.CharField(_('first name'), max_length=30, required=True, blank=False, null=False)
#     last_name = models.CharField(_('last name'), max_length=30, required=True, blank=False, null=False)
#     email = models.EmailField(_('email address'), max_length=255, unique=True, required=True, blank=False, null=False)
